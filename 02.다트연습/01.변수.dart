...
/////////////////////////////////////
  ...
  print("배우정보: $actor");
  print("배우이름은 ${actor["이름"]} 이고 나이는 ${actor["나이"]} 입니다.");

  // List<Map> actorData = [
  // List<Map<String,String>> actorData = [
    // List내부 데이터인 Map형의 제네릭이 없으면 자동으로 dynamic으로 설정됨
  List<Map> actorData = [
  ...
  print("두번째 인물의 이름은 ${actorData[1]["이름"]} 나이는 ${actorData[1]["나이"]}");
